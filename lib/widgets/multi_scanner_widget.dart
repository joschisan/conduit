...
class MultiScannerWidget extends StatefulWidget {
  ...
  final void Function(LnurlWrapper)? onLnurlDetected;
...
class _MultiScannerWidgetState extends State<MultiScannerWidget> {
  ...
  void _processInput(String input) {
    ...
    final decodedNotes = _decoder.addPart(part_: input);
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 16),
              const Text('Detected LNURL', style: TextStyle(fontSize: 18)),
              const Spacer(),
            ],
          ),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pop();
              widget.onLnurlDetected?.call(lnurl);
            },
            style: ElevatedButton.styleFrom(
